...
<div className="flex  items-center  h-full md:flex-row flex-col">
  <div className=" flex flex-col justify-center gap-y-5  p-5 h-full md:w-1/2">
    <div>
        <p className='text-green-700 md:text-left  pb-6  text-center'>Rentify Deposit Free  </p>
        <h1 className='font-semibold text-4xl text-center pb-6 md:text-left md:text-5xl leading-tight'>Spend 35% less when  moving in</h1>

        <p className='font-light pb-8 md:text-left'>Rentify pays your security deposit for a simple, affordable fee.
        </p>
        <div className='flex flex-col md:flex-row gap-y-2 w-full md:w-auto' >
        <button className=" bg-orange-600 text-white rounded-lg outline-none  p-2   w-full">
