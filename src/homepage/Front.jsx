...
function Front() {
  const [isBuyOption, setIsBuyOption] = useState(false);
  return (
    <>
     <section className=" flex items-center justify-center p-8 pt-12">
      <div className="flex justify-between items-center h-full">
        <div className=" flex flex-col justify-center gap-y-7   p-2 h-full w-1/2">
          ...
          {isBuyOption ? (
            <div>
              <h1 className="font-semibold text-5xl pt-3 pb-6">
                The simple and secure{" "}
              </h1>
              <h1 className="font-semibold text-5xl pt-3 pb-6 -mt-3">
                way to buy
              </h1>
            </div>
          ) : (
          ...
          <div className="w-full">
            ...
            <div className="flex gap-x-2 mt-2">
              <span className="bg-blue-300 px-1 py-[0.5px] rounded  text-sm font-light">
                Delhi
              </span>
              <span className="bg-blue-300 p-1 py-[0.5px] rounded text-sm font-light">
                Kolkata
              </span>
              <span className="bg-blue-300 p-1 py-[0.5px] rounded text-sm font-light">
                Mumbai
